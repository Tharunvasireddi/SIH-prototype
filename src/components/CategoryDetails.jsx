...
export default function CategoryDetails() {
  ...
  const categoryName = params?.category ? decodeURIComponent(params.category) : null;
    ...
    return (
      <div className="max-w-6xl mx-auto mt-8 p-6">
        <div className="text-center">
          ...
          <Link to="/analytics" className="text-yellow-600 hover:text-yellow-700 font-medium">
            ← Back to Analytics
          </Link>
        </div>
      </div>
    ...
    <div className="max-w-6xl mx-auto mt-8 p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <h1 className="text-3xl font-bold text-gray-800">{categoryName} Problems</h1>
        </div>
      </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{categoryInfo.stats.total}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-green-600">{categoryInfo.stats.resolved}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-red-600">{categoryInfo.stats.pending}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600">{categoryInfo.stats.avgTime}</p>
            </div>
      ...
      <div className="space-y-4">
        ...
        {categoryInfo.problems.map((problem) => (
          <div key={problem.id} className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
            {/* Problem Header */}
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-4">
              ...
              <div className="flex flex-col lg:flex-row space-y-2 lg:space-y-0 lg:space-x-2 mt-4 lg:mt-0">
                ...
                <span className={`px-3 py-1 rounded-full text-xs font-medium border ${getPriorityColor(problem.priority)}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <span className="font-medium">Duration: {problem.timeTaken}</span>
              </div>
            </div>
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
              <p className="text-sm text-gray-600">
                <span className="font-medium">Assigned to:</span> {problem.department}
              </p>
              {problem.resolvedDate && (
                <p className="text-sm text-green-600 mt-1">
                  <span className="font-medium">Resolved on:</span> {problem.resolvedDate}
                </p>
              )}
            </div>
          </div>
      ...
      {categoryInfo.problems.length === 0 && (
        <div className="text-center py-12">
          <p className="text-gray-500 text-lg">No problems found for this category.</p>
        </div>
      )}
    </div>
  );
